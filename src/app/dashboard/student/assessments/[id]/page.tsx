...
export default function TakeAssessmentPage() {
  ...
  async function startAssessment() {
    ...
    try {
      ...
      const detailsRes = await fetch(`/api/tutor/assessments/${assessmentId}`, {
      ...
      <div className="max-w-3xl mx-auto space-y-6">
        <div className="card-dark rounded-2xl p-8 text-center">
          ...
          {results.passed ? (
            ...
            <p className="text-red-500 mb-6">You didn't meet the passing score of {assessment?.passingScore}%</p>
          )}
          <Link
            href={`/dashboard/student/courses/${assessment?.courseId}`}
  ...
  if (!assessment) {
    return (
      <div className="card-dark rounded-2xl p-12 text-center">
        ...
        <Link href="/dashboard/student/courses" className="btn-primary mt-4">
          Back to Courses
        </Link>
      </div>
    )
